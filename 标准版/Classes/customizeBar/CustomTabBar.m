...
- (void)customTabBar{
    ...
    UIView *tempCustomTab = [[UIView alloc] initWithFrame:CGRectMake( 0.0f , [UIScreen mainScreen].bounds.size.height - 49.0f - 44.0f - 20.0f , 320.0f , 49.0f)];
    ...
    NSArray *itemTitle = [NSArray arrayWithObjects:@"懒人",@"服务",@"社区",@"热点",@"更多",nil];
	NSArray *itemChooseTitle = [NSArray arrayWithObjects:@"产品选中",@"服务选中",@"社区选中",@"热点选中",@"更多选中",nil];
