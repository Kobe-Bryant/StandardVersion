...
//    [self saveAuthorizeDataToKeychain];
	...
	//save user token info and request userInformation
	
    
    if ([delegate respondsToSelector:@selector(engineDidLogIn:didSucceedWithAccessToken:userID:expiresIn:)])
    {
        [delegate engineDidLogIn:self didSucceedWithAccessToken:theAccessToken userID:theUserID expiresIn:seconds];
    }
}
