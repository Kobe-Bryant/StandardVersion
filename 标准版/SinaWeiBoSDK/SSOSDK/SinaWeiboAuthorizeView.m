...
static CGFloat kBorderGray[4] = {0.3, 0.3, 0.3, 0.3};
static CGFloat kBorderBlack[4] = {0.3, 0.3, 0.3, 0.3};
...
//        webView = [[UIWebView alloc] init];
        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 320, [UIScreen mainScreen].bounds.size.height-20-44)];
...
- (void)sizeToFitOrientation:(BOOL)transform
{
    ...
    {
        self.frame = CGRectMake(kPadding, 0, height, width);
    }
    else
    {
        self.frame = CGRectMake(kPadding, 0, width, height);
    }
    self.center = center;
...
- (void)show
{
    ...
    self.frame = CGRectMake(0, 0, innerWidth,[UIScreen mainScreen].bounds.size.height-20-44);
