...
-(void)accessService{
	...
	CommandOperation *commandOpertmp = [[CommandOperation alloc]initWithReqStr:reqStr command:COMPANY_NEWS delegate:self];
...
-(void)update{
	...
	self.companyNewsList = (NSMutableArray *)[DBOperate queryData:T_COMPANYNEWS theColumn:nil theColumnValue:nil withAll:YES];
	if (self.progressHUD) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	browser.linktitle = [companynews objectAtIndex:companynews_pic_name];
...
-(UIImage*)getPhoto:(NSIndexPath *)indexPath{
    ...
    NSString *url = [one objectAtIndex:companynews_pic];
